...
sobre la mesa de juego con todos los componentes que la conforman. Esta información corresponde a los modelos visuales de los elementos y a su \emph{metadata} correspondiente. Para el modelado de los modelos visuales de mesa, habitación, máquina y componentes se utilizó el programa \emph{Blender}, aprovechando una opción de exportación a formato X3D.
