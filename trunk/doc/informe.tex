...
aún no se le habían aplicado texturas y colores. Lo único que se
había hecho era marcar con diversos colores las zonas de ubicación
de cada uno de los componentes de la mesa.

\begin{figure}
\begin{center}
\includegraphics[angle=0,scale=0.4]{images/sin_texturas.eps}
\caption{\emph{HUD de Xtremme Pinball}} \label{no_texturas}
\end{center}
\end{figure}
